var initPhysX = (function () {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  return (
    function (initPhysX) {
      initPhysX = initPhysX || {};

      var Module = typeof initPhysX !== "undefined" ? initPhysX : {};
      var moduleOverrides = {};
      var key;
      for (key in Module) {
      ...
      var DYNAMIC_BASE = 5418320,
        DYNAMICTOP_PTR = 175280;
      ...
      var asmLibraryArg = {
        ...
        "J": __embind_register_value_array,
        ...
        "L": _nanosleep,
        "O": _pthread_cancel,
        "G": _pthread_cond_destroy,
        "H": _pthread_cond_init,
        "E": _pthread_cond_timedwait,
        "M": _pthread_exit,
        "N": _pthread_join,
        "l": _pthread_mutexattr_destroy,
        "q": _pthread_mutexattr_init,
        "o": _pthread_mutexattr_setprotocol,
        "p": _pthread_mutexattr_settype,
        "c": _sched_yield,
        "s": _setTempRet0,
        "table": wasmTable
      };
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = initPhysX;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return initPhysX;
  });
else if (typeof exports === 'object')
  exports["initPhysX"] = initPhysX;